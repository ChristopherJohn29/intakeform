								...
								<div class="row">
									...
									<div class="col-md-12 form-group {{ form_error('prs_providerID') ? 'has-error' : '' }}">
										...
										<div class="dropdown mobiledrs-autosuggest-select">
											<input type="hidden" name="prs_providerID" required="true" value="{{ record['providerID'] }}">
									...
									<div class="col-md-12 form-group {{ form_error('prs_dateOfService') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask required="true" name="prs_dateOfService" value="{{ set_value('prs_dateOfService', record['dateOfService']) }}" data-ajaxUrl="{{ site_url('ajax/provider_route_sheet_management/route_sheet/check_provider_routesheet_by_date') }}">
								...
								<div class="row">
									<div class="patient-details-container">
										...
										{% for index, list in lists %}								
											...
											<input type="hidden" name="prsl_ids[]" value="{{ list['routesheetID'] }}">
											<input type="hidden" name="patientTransDateIDs[]" value="{{ list['patientTransID'] }}">
											...
											<div class="patient-details-item ui-state-default pull-left" style="border:none;"" {{ index > 0 ? "data-item-num=#{ index + 1 }" }}>
												...
												<div class="col-md-4 form-group {{ form_error('prsl_fromTime') ? 'has-error' : '' }}">
													...
													<input  data-timepicker type="text" class="form-control" id="" placeholder="" required="true" name="prsl_fromTime[]" value="{{ list['fromTime'] }}">
	                                            ...
	                                            <div class="col-md-4 form-group {{ form_error('prsl_toTime') ? 'has-error' : '' }}">
	                                                ...
	                                                <input  data-timepicker type="text" class="form-control" id="" placeholder="" required="true" name="prsl_toTime[]" value="{{ list['toTime'] }}">
												...
												<div class="col-md-4 form-group {{ form_error('prsl_patientID') ? 'has-error' : '' }}">
													...
													<div class="dropdown mobiledrs-autosuggest-select">
														<input type="hidden" name="prsl_patientID[]" required="true" value="{{ list['patientID'] }}">
												...
												<div class="col-md-6 form-group {{ form_error('prsl_tovID') ? 'has-error' : '' }}">
													...
													<input type="hidden" name="prsl_tovIDSel" value="{{ list['tovID'] }}">
													<input type="hidden" id="prsl_patientID" value="{{ list['patientTransID'] }}">
												...
												<div class="col-md-6 form-group {{ form_error('prsl_dateRef') ? 'has-error' : '' }}">
													...
													<input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask required="true" name="prsl_dateRef[]" value="{{ list['dateRef'] }}">
												</div>
												...
												<div class="col-md-12 form-group {{ form_error('prsl_notes') ? 'has-error' : '' }}">
													...
													<textarea class="form-control" id="" placeholder="" required="true" name="prsl_notes[]" rows="5">{{ list['notes'] }}</textarea>
