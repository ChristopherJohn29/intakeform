									...
									<tr>
										...
										<td>
											...
											{% if roles_permission_entity.has_permission_name(['view_prs']) %}
												...
												<a target="_blank" href='{{ site_url("provider_route_sheet_management/route_sheet/details/#{ record['routesheetID'] }") }}'><span class="label label-primary">View</span></a>

											{% endif %}

											{% if roles_permission_entity.has_permission_name(['edit_prs'])  %}
												
												<a href='{{ site_url("provider_route_sheet_management/route_sheet/edit/#{ record['routesheetID'] }") }}' title="Edit"><span class="label label-primary">Update</span></a>

											{% endif %}

											{% if roles_permission_entity.has_permission_name(['delete_prs']) %}
												
												<a href='{{ site_url("ajax/provider_route_sheet_management/route_sheet/delete/#{ record['routesheetID'] }") }}' title="Delete" data-delete-btn><span class="label label-primary">Delete</span></a>
