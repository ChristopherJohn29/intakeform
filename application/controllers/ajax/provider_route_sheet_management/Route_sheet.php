...
class Route_sheet extends \Mobiledrs\core\MY_AJAX_Controller {
	...
	public function delete(string $prs_id)
	{
		...
		$rs_list_model_res = $this->rs_list_model->delete_data($rs_list_params, 'routesheet_db');
		$rs_model_res = $this->rs_model->delete_data($rs_params, 'routesheet_db');
	...
	public function check_provider_routesheet_by_date()
	{
		...
		$provider_routesheet = $this->rs_model->records($rs_param, 'routesheet_db');
